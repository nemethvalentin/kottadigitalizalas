...
img = cv2.imread('kepek/tesztkepek/test5.jpg')
...
notes = []
thresholds = [0.793, 0.834, 0.7935, 0.75, 0.83, 0.8, 0.75, 0.85, 0.75, 0.75, 0.75, 0.75, 0.75, 0.8, 0.8, 0.8, 0.8, 0.75, 0.75, 0.7, 0.72, 0.75, 0.815, 0.7715, 0.7, 0.741, 0.75, 0.675, 0.85, 0.68]
c = 1
while c <= 30:
    template = cv2.imread("kepek/templatek/template"+str(c)+".jpg")
    ...
    for pt in zip(*loc[::-1]):
        ...
        notes.append([pt, c])
        cv2.rectangle(gray, pt, (pt[0] + w, pt[1] + h), (0,0,0), -1)
...
#cv2.imwrite("template30.jpg", symbols[141])
cv2.imwrite("smoothfinal.jpg", verticalRGB)
