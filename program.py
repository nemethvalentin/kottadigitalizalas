...
for lines in goodLines2:
    for line in lines:
        cv2.line(img,(line[0],line[1]), (line[2],line[3]), (255,255,255), round(averageGap/4))
        cv2.line(thresh,(line[0],line[1]), (line[2],line[3]), (0,0,0), round(averageGap/4))
...
cv2.imwrite('linesandcontours1.jpg',img)
cv2.imwrite('linesandcontoursthresh1.jpg',thresh)
cv2.waitKey(0)